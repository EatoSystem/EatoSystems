...
export default function EatoAgentPage() {
  ...
  const features = [
    {
      ...
      details:
        "Advanced agent coordination enables seamless automation across the entire food ecosystem, reducing manual work by 80%.",
    },
    {
      ...
      details:
        "Machine learning algorithms process thousands of data points to optimize food production and distribution decisions.",
    },
    {
      ...
      details:
        "API-first architecture enables agents to communicate across EatoAI, EatoBotics, and other system components.",
    },
    {
      ...
      details: "Neural networks adapt to local conditions, seasonal patterns, and emerging challenges in real-time.",
    },
  ]
  ...
  const roadmapMilestones = [
    {
      ...
      description:
        "Launch the core agent framework with basic automation capabilities for farm management and supply chain coordination.",
      deliverables: ["Agent SDK", "Basic Automation", "API Gateway"],
    },
    {
      ...
      status: "upcoming" as const,
      description:
        "Enable multiple agents to work together on complex tasks, with advanced coordination and conflict resolution.",
      deliverables: ["Agent Orchestration", "Conflict Resolution", "Task Distribution"],
    },
    {
      ...
      status: "upcoming" as const,
      description: "Integrate with EatoAI for enhanced decision-making capabilities and predictive analytics.",
      deliverables: ["AI Integration", "Predictive Analytics", "Smart Recommendations"],
    },
    {
      ...
      quarter: "March 2026",
      status: "upcoming" as const,
      description: "Deploy agent networks globally with localized optimization and cross-regional coordination.",
      deliverables: ["Global Deployment", "Localization", "Cross-Regional Sync"],
    },
  ]
  ...
  const contributionAreas = [
    {
      ...
      description: "Build and optimize AI agents for specific food system use cases",
      icon: <Bot className="w-6 h-6" />,
      skills: ["Python", "Machine Learning", "Agent Frameworks"],
    },
    {
      title: "System Integration",
      description: "Connect agents with existing food system infrastructure and APIs",
      icon: <Network className="w-6 h-6" />,
      skills: ["API Design", "System Architecture", "DevOps"],
    },
    {
      title: "Algorithm Optimization",
      description: "Improve agent decision-making algorithms and performance metrics",
      icon: <Brain className="w-6 h-6" />,
      skills: ["Algorithms", "Optimization", "Data Science"],
    },
    {
      title: "User Experience",
      description: "Design intuitive interfaces for agent management and monitoring",
  ...
  return (
    <>
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-800 text-center">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">
                    The Intelligence Layer of Food Systems
                  </span>
                </h2>

                <div className="prose prose-lg max-w-none text-slate-600 space-y-6">
                  <p className="text-xl leading-relaxed">
                    EatoAgent is the intelligent orchestration layer that deploys AI agents throughout the food
                    ecosystem, automating complex tasks and optimizing operations from farm to table.
                  </p>

                  <p>
                    As the <strong>SEED</strong> layer of EatoSystems, EatoAgent plants the intelligence that grows into
                    comprehensive automation. These AI agents work autonomously to manage crops, optimize supply chains,
                    coordinate logistics, and ensure food safety across the entire system.
                  </p>

                  <p>
                    EatoAgent enables <strong>intelligent automation</strong> — deploying specialized agents that can
                    make real-time decisions based on environmental data, market conditions, and sustainability metrics.
                    It provides <strong>seamless coordination</strong> — ensuring all agents work together harmoniously
                    across different systems and locations.
                  </p>

                  <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-8">
                    <p className="text-blue-800 font-medium mb-2">Your Role in Agent Development</p>
                    <p className="text-blue-700">
                      Whether you're an AI researcher, software developer, systems architect, or domain expert —
                      EatoAgent provides the platform to build intelligent solutions that transform how food systems
                      operate.
                    </p>
                  </div>

                  <h3 className="text-2xl font-bold text-gray-800 mt-12 mb-6">Core Capabilities</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                      ...
                      <p className="text-gray-600">
                        Deploy and manage thousands of AI agents across different food system components with
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                      ...
                      <h4 className="text-lg font-bold mb-2">Autonomous Decision Making</h4>
                      <p className="text-gray-600">
                        Agents make intelligent decisions in real-time, adapting to changing conditions and optimizing
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                      ...
                      <p className="text-gray-600">
                        Seamlessly connect with all EatoSystems components, creating a unified intelligent ecosystem
                        that works as one.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                      ...
                      <p className="text-gray-600">
                        Agents continuously learn and improve their performance, adapting to local conditions and
                        emerging challenges.
                      </p>
                    </div>
                  </div>
        ...
        <section id="roadmap-section" className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Key milestones in the development and deployment of EatoAgent as the intelligent orchestration layer of
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                {/* Timeline line */}
                <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 to-indigo-500 transform md:-translate-x-px"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Contribute to the future of intelligent food systems through AI agent development, system integration,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-800">EatoAgent Lab</h3>
                <p className="text-gray-600 mb-6">
                  Access agent development frameworks, APIs, and simulation environments to build and test AI agents for
                  food system automation.
                </p>
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-800">Agent Documentation</h3>
                <p className="text-gray-600 mb-6">
                  Comprehensive guides for agent architecture, deployment strategies, and best practices for building
                  intelligent food system automation.
                </p>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center text-sm text-gray-600">
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              Join the EatoAgent community and help develop AI agents that will transform how food systems operate
              worldwide. Your expertise can make a difference.
            </p>
