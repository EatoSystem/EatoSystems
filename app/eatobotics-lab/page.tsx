  ...
  const contributionGroups = [
    {
      ...
      icon: <Cog size={24} />,
      link: "/contribute/hardware-engineering",
      color: "from-green-500 to-emerald-600",
    },
    {
      name: "v0.dev Builders",
      description: "Design and build interfaces for robot control, monitoring systems, and data visualization tools.",
      icon: <Code size={24} />,
      link: "/contribute/v0",
  ...
  const devResources = [
    {
      title: "Robotics SDK",
      description:
        "Complete development toolkit for creating and deploying regenerative robotics with pre-built components.",
      icon: <Bot size={24} />,
      link: "#",
      buttonText: "Get SDK",
    ...
    {
      title: "Robotics UI Kit",
      description:
        "UI components and design patterns specifically designed for robotics control interfaces and monitoring systems.",
      icon: <Figma size={24} />,
      link: "#",
  ...
  const labStats = [
    {
      ...
      description: "Active prototyping & testing",
      icon: <Rocket className="w-6 h-6" />,
    },
    {
      number: "Q3 2025",
      label: "Target Launch",
      description: "First robotics deployment",
    ...
    },
    {
      number: "47+",
      label: "Countries",
      description: "Global robotics network",
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-700">
            <Image
              src="/images/systems/eatobotics-sprout.png"
              alt="EatoBotics Laboratory"
              fill
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-32 text-center text-white">
            ...
            >
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-8 py-4 mb-12 border border-white/30">
                <Bot className="w-6 h-6 mr-3 text-green-200" />
                <span className="text-white font-semibold text-lg">EatoBotics Research Laboratory</span>
                <Badge className="ml-3 bg-orange-500 text-white border-0">Beta</Badge>
              </div>

              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight tracking-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-200 via-emerald-200 to-teal-300">
                  EatoBotics
                </span>
                <br />
              ...
              <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed text-white/90 font-light">
                Developing regenerative robotics and intelligent tools that work in harmony with natural systems. Join
                our research community building the future of sustainable agriculture technology.
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-green-600 to-emerald-500">Research Framework</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Our systematic approach to developing regenerative robotics that work in harmony with natural ecosystems
              </p>
            </motion.div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative">
                <div className="absolute left-8 md:left-1/2 transform md:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-green-500 via-emerald-500 to-teal-500"></div>
                      ...
                      <div className={`w-full md:w-5/12 ml-16 md:ml-0 ${isLeft ? "md:pr-8" : "md:pl-8"}`}>
                        <Card
                          className={`transition-all duration-300 ${
                            isActive ? "shadow-xl border-green-200 scale-105" : "shadow-lg hover:shadow-xl"
                          }`}
                        >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-green-600 to-emerald-500">Join Our Research Community</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Collaborate with engineers, ecologists, and robotics specialists from around the world
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-green-600 to-emerald-500">Development Resources</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Everything you need to start building and contributing to EatoBotics
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
                <Sparkles className="w-5 h-5 mr-2 text-green-200" />
                <span className="text-white font-semibold">Ready to Build the Future?</span>
              </div>

              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Join the EatoBotics Research Lab</h2>

              <p className="text-xl text-white/90 mb-12 leading-relaxed">
                Be part of the global community developing regenerative robotics that heal the planet while feeding the
                world. Your expertise can help create intelligent tools that work in harmony with nature.
              </p>
