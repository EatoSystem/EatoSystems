...
export default function EatoVerseLabPage() {
  ...
  const labStats = [
    ...
    },
    {
      number: "Q3 2026",
      label: "Target Launch",
      description: "Digital twin deployment",
    ...
    },
    {
      number: "19+",
      label: "Countries",
      description: "Global simulation network",
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-32 text-center text-white">
            ...
            >
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-8 py-4 mb-12 border border-white/30">
                <Cube className="w-6 h-6 mr-3 text-purple-200" />
                <span className="text-white font-semibold text-lg">EatoVerse Research Laboratory</span>
              ...
              <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed text-white/90 font-light">
                Building digital twin technology for food system simulation and design. Join our research community
                creating virtual prototypes before real-world implementation.
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Our systematic approach to developing digital twin technology for food systems
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Collaborate with 3D artists, developers, and simulation specialists from around the world
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Everything you need to start building and contributing to EatoVerse
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gradient-to-r from-purple-600 to-violet-600">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Join the EatoVerse Research Lab</h2>

              <p className="text-xl text-white/90 mb-12 leading-relaxed">
                Be part of the global community creating digital twins of food systems. Your expertise can help
                prototype the future before it's built in the real world.
              </p>
