...
export default function EatoCulturesLabPage() {
  ...
  const contributionGroups = [
    ...
    },
    {
      name: "UX Designers",
      description:
        "Create intuitive interfaces and design patterns for building culturally appropriate and accessible interfaces.",
      icon: <Figma size={24} />,
  ...
  const devResources = [
    {
      title: "Storytelling Platform SDK",
      description:
        "Complete development toolkit for creating cultural storytelling platforms with pre-built components for audio, video, and text.",
      icon: <Mic size={24} />,
      link: "#",
      buttonText: "Get SDK",
    ...
    {
      title: "Cultural Design System",
      description:
        "UI components and design patterns specifically designed for culturally appropriate storytelling interfaces.",
      icon: <Figma size={24} />,
      link: "#",
    ...
    },
    {
      ...
      description: "Tools for capturing, editing, and sharing cultural stories in multiple formats and languages.",
      icon: <Camera size={24} />,
      link: "#",
  ...
  const labStats = [
    {
      ...
      description: "Advanced cultural preservation",
      icon: <Award className="w-6 h-6" />,
    },
    {
      number: "Jun 2026",
      label: "Target Launch",
      description: "Q2 2026 platform deployment",
      icon: <Calendar className="w-6 h-6" />,
    },
    {
      number: "5",
      label: "Framework Steps",
      description: "Systematic cultural approach",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      number: "Global",
      label: "Impact Scale",
      description: "Worldwide cultural preservation",
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-32 text-center text-white">
            ...
            >
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-8 py-4 mb-12 border border-white/30">
                <Heart className="w-6 h-6 mr-3 text-amber-200" />
                <span className="text-white font-semibold text-lg">EatoCultures Research Laboratory</span>
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight tracking-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-orange-200 to-red-300">
                  EatoCultures
                </span>
                <br />
              ...
              <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed text-white/90 font-light">
                The SOIL of EatoSystems — preserving and activating human knowledge to power the future of food. Join
                our research community capturing the stories that feed our world.
              </p>

              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
                <Button
                  size="lg"
                  className="bg-white text-amber-600 hover:bg-gray-100 px-10 py-5 text-xl font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 rounded-full"
                >
                  Join Research Lab <ArrowRight className="ml-3 h-6 w-6" />
                </Button>
                <Link href="/eatocultures">
                  <Button
                    size="lg"
                    variant="outline"
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-amber-600 to-orange-500">Cultural Framework</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Our systematic approach to preserving and sharing cultural knowledge while respecting traditions
              </p>
            </motion.div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative">
                <div className="absolute left-8 md:left-1/2 transform md:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-amber-500 via-orange-500 to-red-500"></div>
                    ...
                    >
                      ...
                      <div
                        className={`absolute left-8 md:left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full z-10 ${
                          isCompleted ? "bg-green-500" : isActive ? "bg-amber-500" : "bg-gray-300"
                        }`}
                      ></div>
                      ...
                      <div className={`w-full md:w-5/12 ml-16 md:ml-0 ${isLeft ? "md:pr-8" : "md:pl-8"}`}>
                        <Card
                          className={`transition-all duration-300 ${
                            isActive ? "shadow-xl border-amber-200 scale-105" : "shadow-lg hover:shadow-xl"
                          }`}
                        >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-amber-600 to-orange-500">Join Our Research Community</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Collaborate with cultural experts, storytellers, and researchers from around the world
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-amber-600 to-orange-500">Development Resources</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Everything you need to start building and contributing to EatoCultures
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gradient-to-r from-amber-600 to-orange-600">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Join the EatoCultures Research Lab</h2>

              <p className="text-xl text-white/90 mb-12 leading-relaxed">
                Be part of the global community preserving and activating cultural knowledge for sustainable food
                systems. Your stories can help feed the world.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                <Link href="/roadmap/eatocultures">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white text-white hover:bg-white/10 px-10 py-5 text-xl rounded-full"
