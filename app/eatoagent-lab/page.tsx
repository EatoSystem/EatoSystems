...
export default function EatoAgentLabPage() {
  ...
  const frameworkSteps = [
    {
      ...
      description:
        "Establish technical requirements, ethical principles, and success metrics for autonomous food system agents.",
      icon: <Bot size={20} />,
      status: "planning",
    },
    {
    ...
    },
    {
      ...
      description: "Develop agent frameworks, coordination protocols, and human-agent interfaces with community input.",
      icon: <Code size={20} />,
      status: "upcoming",
    },
    {
  ...
  const contributionGroups = [
    ...
    },
    {
      ...
      description: "Design and build interfaces for agent configuration, monitoring, and human-agent collaboration.",
      icon: <Code size={24} />,
      link: "/contribute/v0",
    ...
    {
      name: "Domain Experts",
      description: "Provide specialized knowledge in agriculture, logistics, nutrition, and other food system domains.",
    ...
    {
      name: "UX Designers",
      description: "Create intuitive interfaces that make complex agent systems accessible to diverse stakeholders.",
      icon: <Figma size={24} />,
  ...
  const devResources = [
    {
      title: "Agent Framework SDK",
      description:
        "Complete development toolkit for creating and deploying specialized food system agents with pre-built components.",
      icon: <Bot size={24} />,
      link: "#",
      buttonText: "Get SDK",
    ...
    {
      title: "Agent UI Kit",
      description: "UI components and design patterns specifically designed for agricultural AI agent interfaces.",
      icon: <Figma size={24} />,
      link: "#",
    ...
    },
    {
      ...
      description: "Test agent behavior and performance in a virtual food system environment before deployment.",
  ...
  const labStats = [
    ...
    },
    {
      number: "Dec 2025",
      label: "Target Launch",
      description: "Q4 2025 system deployment",
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-32 text-center text-white">
            ...
            >
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-8 py-4 mb-12 border border-white/30">
                <Bot className="w-6 h-6 mr-3 text-cyan-200" />
                <span className="text-white font-semibold text-lg">EatoAgent Research Laboratory</span>
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight tracking-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 via-blue-200 to-teal-300">
                  EatoAgent
                </span>
                <br />
              ...
              <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed text-white/90 font-light">
                Building autonomous agents that coordinate and optimize food systems at every scale. Join our research
                community developing intelligent agents for sustainable agriculture.
              </p>

              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
                <Button
                  size="lg"
                  className="bg-white text-teal-600 hover:bg-gray-100 px-10 py-5 text-xl font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 rounded-full"
                >
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-teal-600 to-cyan-500">Research Framework</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Our systematic approach to developing breakthrough autonomous agents for food systems
              </p>
            </motion.div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative">
                <div className="absolute left-8 md:left-1/2 transform md:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-teal-500 via-cyan-500 to-blue-500"></div>
                    ...
                    >
                      ...
                      <div
                        className={`absolute left-8 md:left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full z-10 ${
                          isCompleted ? "bg-green-500" : isActive ? "bg-teal-500" : "bg-gray-300"
                        }`}
                      ></div>
                      ...
                      <div className={`w-full md:w-5/12 ml-16 md:ml-0 ${isLeft ? "md:pr-8" : "md:pl-8"}`}>
                        <Card
                          className={`transition-all duration-300 ${
                            isActive ? "shadow-xl border-teal-200 scale-105" : "shadow-lg hover:shadow-xl"
                          }`}
                        >
                            ...
                            <div className="flex items-center mb-4">
                              <div
                                className={`w-12 h-12 rounded-xl flex items-center justify-center mr-4 ${
                                  isCompleted ? "bg-green-500" : isActive ? "bg-teal-500" : "bg-gray-400"
                                } text-white`}
                              >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-teal-600 to-cyan-500">Join Our Research Community</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Collaborate with researchers, developers, and domain experts from around the world
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                <span className="gradient-text from-teal-600 to-cyan-500">Development Resources</span>
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Everything you need to start building and contributing to EatoAgent
              </p>
            </motion.div>
        ...
        <section className="py-24 bg-gradient-to-r from-teal-600 to-cyan-600">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Join the EatoAgent Research Lab</h2>

              <p className="text-xl text-white/90 mb-12 leading-relaxed">
                Be part of the global community building autonomous agents for sustainable food systems. Your expertise
                can help create the future of agriculture.
              </p>
