          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight tracking-tight">
              <div className="flex items-center justify-center flex-wrap gap-2 sm:gap-3">
                <Sparkles className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-green-300 flex-shrink-0" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-200 via-emerald-200 to-blue-300">
                  EatoGlobal
                </span>
              </div>
              <span className="block mt-2 sm:mt-3 text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white/90 font-light">
                v1.0 • The Foundation Layer
              </span>
            </h1>

            {/* Description */}
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 md:mb-12 max-w-4xl mx-auto leading-relaxed text-white/90 font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-12 sm:mb-16 md:mb-20">
              <div className="transform hover:scale-105 active:scale-95 transition-transform w-full sm:w-auto">
                ...
                >
                  Explore Features <ArrowRight className="ml-2 sm:ml-3 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
                </Button>
              </div>

              <div className="transform hover:scale-105 active:scale-95 transition-transform w-full sm:w-auto">
                <Link href="/eatosystems/eatoglobal-lab">
                  <Button
                    size="lg"
                  ...
                  >
                    <Code className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
                    Developer Lab
                  </Button>
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/30 shadow-lg">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 mx-auto mb-3 sm:mb-4 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                  <Calendar className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                </div>
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">Q3</div>
                <div className="text-sm sm:text-base text-white/90 mb-1">2025</div>
                <div className="text-xs sm:text-sm text-white/80">Launch Date</div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/30 shadow-lg">
                ...
                <div className="text-sm sm:text-base text-white/90 mb-1">Countries</div>
                <div className="text-xs sm:text-sm text-white/80">Global Reach</div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/30 shadow-lg">
                ...
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">1M+</div>
                <div className="text-sm sm:text-base text-white/90 mb-1">Communities</div>
                <div className="text-xs sm:text-sm text-white/80">Target Reach</div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/30 shadow-lg">
                ...
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">SOIL</div>
                <div className="text-sm sm:text-base text-white/90 mb-1">Layer</div>
                <div className="text-xs sm:text-sm text-white/80">Foundation</div>
              </div>
            </div>
          </motion.div>
        </div>
