          ...
          <div className="flex items-center justify-between h-12">
            ...
            <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              ...
              {/* <div className="transform hover:scale-105 active:scale-95 transition-transform">
                 <Link
                   href="#contact"
                   className="text-sm lg:text-base text-gray-800 hover:text-primary transition-colors font-medium"
              ...
              {/* <div className="transform hover:scale-105 active:scale-95 transition-transform">
                 <Link href="/start-building">
                   <Button className="premium-btn bg-primary hover:bg-primary text-green-600 rounded-full px-4 lg:px-6 py-2 text-sm lg:text-base transition-all duration-300">
                     Start Building
+                  </Button>
                 </Link>
               </div> */}
