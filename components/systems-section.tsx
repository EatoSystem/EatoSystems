          ...
          <Card className="group cursor-pointer transition-all duration-300 hover:shadow-xl border-0 bg-white shadow-lg">
            <CardContent className="p-0">
              ...
              <div className="relative h-40 overflow-hidden rounded-t-lg">
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${layerColors[layer as keyof typeof layerColors]}`}
                />
                {!imageError ? (
                  <Image
                ...
                <div className="absolute top-2 left-2">
                  <Badge
                    className={`bg-white/90 ${layerTextColors[layer as keyof typeof layerTextColors]} font-medium text-xs`}
                  >
                    {layer}
                  </Badge>
                </div>
                <div className="absolute top-2 right-2">
                  <Badge variant="outline" className="bg-white/90 border-gray-200 text-gray-600 font-mono text-xs">
                    {version}
                  </Badge>
                </div>
              </div>
              ...
              <div className="p-4">
                <div className="mb-3">
                  <h3
                    className={`text-xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r ${layerGradients[layer as keyof typeof layerGradients]}`}
                  >
                    {name}
                  </h3>
                ...
                <div className="text-center">
                  ...
                  >
                    Visit {name}.com <ExternalLink className="w-2 h-2" />
                  </a>
                </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="relative h-48 overflow-hidden rounded-t-lg">
                ...
                <div className="absolute top-4 left-4">
                  <Badge
                    className={`bg-white/90 ${layerTextColors[layer as keyof typeof layerTextColors]} font-medium`}
                  >
                    {layer}
                  </Badge>
                </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-0">
          <div className="relative">
            <div
              className="hidden md:block absolute left-1/2 transform -translate-x-0.5 w-0.5 h-full bg-gradient-to-b from-green-500 via-orange-500 to-green-500"
              aria-hidden="true"
            />
